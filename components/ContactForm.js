...
export default function ContactForm() {
  return (
    <Fragment>
        <h1 className="text-left md:px-0 text-5xl font-bold md:inline-block py-2 rounded-md text-[#FFF200]">
            O que prometemos? Mais que likes, uma gestão estratégica das suas redes sociais! 
        </h1>
        <h3 className="text-[1rem] mb-8 md:w-[100%] md:text-left text-center font-bold">
